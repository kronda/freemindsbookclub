...
set :application, "freemindsbookclub"
...
set :scm, :git
set :repository,  "git@github.com:kronda/freemindsbookclub.git"
# set :scm, :subversion
...
set :local_path, "/Users/Kronda/Sites/freemindsbookclub"
...
set :local_domain, 'freemindsbookclub.kdev.com'